...
echo on
title Realstate
set SOLR_PARMS=-Dsolr.solr.home=E:\bigfish-project\ofbiz-1202-real/hot-deploy/solr -Dsolr.data.dir=E:\bigfish-project\ofbiz-1202-real/hot-deploy/solr/data
"C:\Program Files\Java\jdk1.7.0_09\bin\java" -Xms512M -Xmx512M -XX:MaxPermSize=128m %SOLR_PARMS% -jar ofbiz.jar
