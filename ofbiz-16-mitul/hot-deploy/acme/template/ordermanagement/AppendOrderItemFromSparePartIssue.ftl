...
<div class="screenlet">
  ...
  <div class="screenlet-body">
        <form method="post" action="<@ofbizUrl>addItemToOrderFromSparePartIssue</@ofbizUrl>" name="appendItemForm">
            <input type="hidden" size="25" name="orderId" value="${orderHeaderAndjobCardGV.orderId!}"/>
            <input type="hidden" size="25" name="jobCardId" value="${orderHeaderAndjobCardGV.jobCardId!}"/>
            ...
            <table class="basic-table" cellspacing="0">
              ...
              <#--  if (shipGroups?size > 1)>
                <tr>
                  ...
                  <td>
                      <input type="hidden" size="6" name="shipGroupSeqId" value="00001"/>
                  </td>
                </tr>
              </#if>
                <tr>
                ...
                <#if orderItemChangeReasons?exists && orderItemChangeReasons?has_content>
                <tr>
