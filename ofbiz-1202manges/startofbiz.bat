...
echo on
title Manges
set SOLR_PARMS=-Dsolr.solr.home=E:\bigfish-project\ofbiz-1202manges/hot-deploy/solr -Dsolr.data.dir=E:\bigfish-project\ofbiz-1202manges/hot-deploy/solr/data
